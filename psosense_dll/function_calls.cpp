...
{
    if (!IsTouchSlowEnabled())
    {
        SetTouchSlowEnabled(true);
        std::cout << "[CALL] Bloqueio de StartTouchSlowDown ATIVADO.\n";
    }
    else
    {
        std::cout << "[CALL] Bloqueio de StartTouchSlowDown já estava ativado.\n";
    }
}
...
void ExecuteDisableTouchSlow()
{
    if (IsTouchSlowEnabled())
    {
        SetTouchSlowEnabled(false);
        std::cout << "[CALL] Bloqueio de StartTouchSlowDown DESATIVADO.\n";
    }
    else
    {
        std::cout << "[CALL] Bloqueio de StartTouchSlowDown já estava desativado.\n";
    }
}
